  ...
  <div v-else class="nav-home">
    ...
    <aside class="sidebar">
      ...
      <div class="logo-section">
        ...
        <h1 class="site-title">{{ title || '小步导航' }}</h1>
      </div>
      ...
      <div class="sidebar-footer">
        <a
          href="https://github.com/FrightSega/mao_nav"
          target="_blank"
        ...
        >
          ...
          <span>风的方向是由树决定,人的方向是由自已决定！🗺️</span>
        </a>
      </div>
    </aside>
        ...
        <div v-else class="categories-container">
          ...
          <footer class="page-footer" hidden="true">
            ...
            <div class="footer-bottom">
              <p>&copy; {{ new Date().getFullYear() }} 小步导航 - 由 <a href="https://github.com/FrightSega/mao_nav" target="_blank" rel="noopener noreferrer">小步</a> 用 ❤️ 制作</p>
              <p class="footer-tech">基于 Vue.js 构建 | <a href="https://github.com/FrightSega/mao_nav" target="_blank" rel="noopener noreferrer">查看源代码</a></p>
            </div>
          </footer>
        </div>
      </div>
...
// 打开GitHub项目页面
const openGitHub = () => {
  window.open('https://github.com/FrightSega/mao_nav', '_blank')
}
